...
## 4. Các câu lệnh thao tác với DB Link

### 4.1. Câu lệnh tạo Private DB Link
```sql
...
### 4.2. Câu lệnh tạo Public DB Link
...
### 4.3. Lệnh kiểm tra kết nối (Ping DB Link)
...
## 5. Quản lý danh sách DB Link trong hệ thống
